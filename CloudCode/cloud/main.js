    ...
    success: function(results1) {
        ...
        success: function(results2) {
            ...
            for(var i = 0; i < results2.length; i++){
                ...
                addIngredPartJS = createIngredPartJS(results2[i].get("ingredient").id, results2[i].get("ingredient").get("name"), results2[i].get("ingredient").get("optional"));
            ...
            success: function(results3) {
                ...
                for(var n=0; n < results3.length; n++){
                    addIngredPartJS = createIngredPartJS(results3[n].get("ingredient").id, results3[n].get("ingredient").get("name"), results3[n].get("ingredient").get("optional"));
